...
export default function LocalFileWriterNode({ id, data, selected }: HubNodeProps) {
  ...
  return (
    <div className={`rounded-lg border px-3 py-2 bg-amber-950 border-amber-700 min-w-[160px] ${selected ? "ring-2 ring-amber-400" : statusRing}`}>
